...
class AdminController extends Controller
{
    ...
    public function postTambahAdmin(Request $request){
        ...
        if($buku) {
            return redirect()->route('admin.buku')->with('success', 'Buku baru berhasil ditambahkan!');
        } else{
        ...
        public function adminPeminjaman(Request $request) {
            ...
            $peminjaman->save();
                ...
                if($peminjaman){
                return redirect()->route('admin.peminjaman')->with('success', 'Data peminjaman berhasil di update!'); 
            } else {
